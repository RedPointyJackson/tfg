...
% E,  M→q, C, χ, C₄
  ...
  \begin{center}
    \begin{tikzpicture}
      \draw[|->, thick] (0,0) -- (10,0) node[at end, below] {\Large $t$};
      \draw (3,0.25) -- (3,-0.25) node[below] {\Large $t_w$};
      \draw (7,0.25) -- (7,-0.25) node[below] {\Large $t_w+t_0$};
      \draw[<->] (3.2,0.3) to[out=30, in=150] (6.8,0.3);
      \node[fill=white] at (5,0.75) {\Large $t₀$};
    \end{tikzpicture}
  \end{center}
\end{frame}
...
\begin{frame}
  \frametitle{Rejuvenecimiento}
  ¿Por qué rejuvenecimiento débil?
  \begin{center}
